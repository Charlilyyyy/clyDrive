...
import com.clydrive.dtos.request.MoveFileRequest;
...
public class FileController {
    ...
    public ResponseEntity<ApiResponse<FileResponse>> moveFile(
        ...
        log.info("[FILE_MOVE] Request received | fileId={} | targetFolderId={}", id, request.getFolderId());
        FileResponse response = fileService.moveFile(id, request.getFolderId());
        return ResponseEntity.ok(ApiResponse.success(
                HttpStatus.OK.value(), "File moved successfully", servletRequest.getRequestURI(), response));
    }
